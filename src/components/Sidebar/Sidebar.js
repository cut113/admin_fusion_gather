...
import { renderThumbDark, renderThumbLight, renderTrack, renderTrackRTL, renderView, renderViewRTL } from 'components/Scrollbar/Scrollbar';
...
function Sidebar(props) {
  ...
  const createLinks = routes => {
    ...
    let inactiveColor = useColorModeValue('gray.500', 'gray.700');
